...
// use avila_time::DateTime;  // TODO: Add when avila-time is available
...
pub struct Email {
    ...
    /// Send date (TODO: needs avila_time)
    // pub date: DateTime,
    /// Attachments
...
impl Email {
    ...
    pub fn new(from: EmailAddress, to: Vec<EmailAddress>, subject: String, body: String) -> Self {
        Self {
            ...
            html_body: None,
            headers: HashMap::new(),
            // date: DateTime::now(),  // TODO: Add when avila_time is available
            attachments: Vec::new(),
        }
    }
    ...
    fn generate_message_id() -> String {
        // TODO: Use avila_time::DateTime when available
    ...
    pub fn to_mime(&self) -> String {
        ...
        // TODO: Add Date header when avila_time is available
