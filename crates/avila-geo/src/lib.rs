...
pub mod cartography; // Framework de cartografia (Europa, África, Ásia)
pub mod aviladb_cartographic; // Database cartográfico pessoal
...
pub use cartography::{
    Map as CartographyMap,
    coordinates::{LatLon, Point2D, BoundingBox},
    continents::{Europe, Africa, Asia, Continent, Country},
    projection::{Projection as CartographyProjection, Mercator as CartographyMercator, Robinson as CartographyRobinson, AlbersEqualArea as CartographyAlbers},
    renderer::{MapRenderer, SvgRenderer, JsonRenderer, RenderOptions, Style as CartographyStyle, OutputFormat},
    viewport::{Viewport, ZoomLevel},
    features::{City, River, Mountain, Feature, CityDatabase},
    tiles::{Tile, TileGrid},
};
