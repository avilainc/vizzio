...
impl Cubic {
    ...
    fn cubic_window(&self, now: u64) -> u64 {
        ...
        let delta = t - self.k;
        let w = C * delta * delta * delta + self.w_max as f64;
...
impl CongestionController for Cubic {
    ...
    fn on_loss(&mut self, bytes_lost: u64, now: u64) {
        ...
        const BETA: f64 = 0.3;
        const C: f64 = 0.4;
        self.k = cubic_root((self.w_max as f64 * BETA) / C);
...
/// Aproxima a raiz cúbica usando iteração de Newton.
fn cubic_root(value: f64) -> f64 {
    if value <= 0.0 {
        return 0.0;
    }
