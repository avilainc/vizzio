...
//!
//! High-performance arbitrary-precision integer arithmetic optimized for cryptographic operations.
//!
//! ## Features
//! - **Fixed-size types**: U256, U512, U1024, U2048, U4096, I4096
//! - **Cryptographic operations**: Modular arithmetic, prime generation, RSA
...
//!
//! ## Types
//! - [`U256`]: 256-bit unsigned integer (32 bytes) - Elliptic curves
//! - [`U512`]: 512-bit unsigned integer (64 bytes)
...
pub use types::{U256, U512, U1024, U2048, U4096, I4096};
